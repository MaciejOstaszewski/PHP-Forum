        ...
        <div id="from_container">
          <div id="form_border">
            <?php
              ...
              echo "<form action='services/editTopic.php?id=".$_GET['id']."&idDzialu=".$_GET['idDzialu']."&nazwaDzialu=".$_GET['nazwaDzialu']."' method='post'>";


          echo  "Nazwa tematu:<br />
                <input type='text' name='nazwa' value='".$_GET['nazwaTematu']."' ><br /><br />
                Treść posta:<br /><br />
                <textarea rows='4' cols='50' name='contents'>".$_GET['trescTematu']."</textarea>";
            ?>
