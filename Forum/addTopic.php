    ...
    <section>
      ...
      <li><a href="rules.php">Regulamin</a></li>
        ...
        <div id="from_container">
          <div id="TopicForm_border">
            <?php
              echo "<form id='addTopicForm' action='services/newTopic.php?id=".$_GET['id']."&nazwaDzialu=".$_GET['nazwaDzialu']."' method='post'>";

            ?>
            Nazwa tematu:<br />
            <input type="text" name="nazwa" class="required" >
          <br /><br />Treść posta:<br /><br />
